          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                We offer digitally planned aligner solutions for patients who
                want invisible teeth straightening with comfort and convenience.
                In selected cases,{" "}
                <Link
                  to="/smile-makeover"
                  className="text-blue-600 font-semibold hover:underline"
                ...
                planning may also be discussed after alignment.
              </p>
            </div>

            <div className="space-y-8">
              {alignerTypes.map((type, index) => (
                <div
                  key={index}
